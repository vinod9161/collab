...
<footer style="text-align:center;padding:10px;">
	<a href="<?php echo Router::url('/', true); ?>/homes/download_document?title=<?php echo str_replace(' ','_',$title); ?>" style="color: rgb(36, 121, 216); font-size: 16px;">Download printable PDF <img style="width: 35px; margin-bottom: -5px;" src="<?php echo Router::url('/', true); ?>/images/pdf.png"></a>
</footer>
<?php
